...
\node[default] (press) at (7,25) {
        \includegraphics[width=.4\textwidth]{images/springer.png}};
        }{
\node[default] (press) at (7,25) {
        \includegraphics[width=.4\textwidth]{images/ubp.png}};    
}
\node[default] (tao) [right=of press] {
...
\node[default] (centron) at (30,10) {
        \includegraphics[width=.6\textwidth]{images/centron.png}
    };

\node[default] (insius) [below=of centron] {
...
\node[default] (qr) at (0,0) {
        \includegraphics[width=.2\textwidth]{images/qrcode.png}
    };
\node[default, unibablueI] (url) [below=of qr]{\url{www.mmb2014.de}};
\end{tikzpicture}
\end{center}