...
\VertEntry{10:15 \qquad\quad $\vert$ \qquad 11:35} & \multicolumn{2}{p{6.5cm}|}{Proposal for Heuristics-based Refinement in Clustering Problems} \\
  \cline{2-3}
...
\endhead
 ...
 \cline{2-3}
\VertEntry{11:50 \qquad\quad $\vert$ \qquad 12:50} & \multicolumn{2}{p{6.5cm}|}{\textbf{D. Hevenstone}:} \\
