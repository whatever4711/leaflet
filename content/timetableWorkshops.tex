...
%
\node[day] (fg) at (9,0) {FGENET};
\node[day] (so) [right = of fg] {SOCNET};
\node[day] (wo) [right = of so] {WoNeCa};
%
...
\node[hour] (1640) [below = \hourseparation of 1520] {16:40};
...
\node[hours, minimum height = \threeslots, fill=unibayellowV] (soil2) [below = of solb] {Invited Lecture\\ P.A. Gloor};
...
\node[hours, minimum height = \threeslots, fill=unibayellowV] (wok) [below = of wos2] {Keynote\\ J. Liebeherr};
...
\node[hours, minimum height = \threeslots, fill=unibablueV] (wos4) [below = of wocb2] {Session 4};
